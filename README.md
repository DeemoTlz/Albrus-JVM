...
#### 5.4.1 亿级流量电商系统如何优化 JVM 参数设置(ParNew + CMS)
...
load average: 1.61, 0.90, 0.41

系统 1 分钟、5 分钟、15 分钟的评价负载，平均值超过 60% 系统负载压力较大
...
![image-20220711215136290](images/image-20220711215136290.png)
...
%util：一秒中有百分之几的时间用于 I/O 操作，值越大，说明 I/O 压力越大

`pidstat -d 2 -p pid`：查看读写速率
...
1. `top` 查看占用 CPU 较高的程序 -> 线程

   ![img](images/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1hJTllBTkdYSU5OSUFO,size_16,color_FFFFFF,t_70.png)

2. `ps -mp pid -o THREAD,tid,time`

   ![image-20220711220626282](images/image-20220711220626282.png)
